      ...
      <div className="relative z-10 text-center text-white px-4 max-w-6xl mx-auto transform -translate-y-16 sm:-translate-y-20 md:translate-y-0">
        <div className="relative">
          <div className="relative bg-black/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 md:p-12 border border-blue-500/30">
            <h1 className="text-4xl sm:text-6xl md:text-6xl lg:text-7xl font-black mb-6 font-jakarta">
            ...
            <Link href="/caps">
              <Button className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold px-8 md:px-8 py-4 text-xl sm:text-2xl md:text-2xl tracking-wide shadow-2xl hover:shadow-blue-500/50 transition-all duration-300 transform hover:scale-105 font-jakarta">
