      ...
      <div className="relative z-10 text-center text-white px-4 max-w-6xl mx-auto transform -translate-y-16 sm:-translate-y-20 md:translate-y-0">
        <div className="relative">
          <div className="relative bg-black/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 md:p-12 border border-blue-500/30">
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-black mb-6 tracking-wider font-jakarta leading-tight">
            ...
            <p className="text-xl sm:text-2xl md:text-3xl mb-8 text-blue-200 font-semibold font-deardorf">
              {subtitle ?? "Ogni cappello racconta la tua storia, con fiamme e stile."}
            </p>

            <Link href="/caps">
              <Button className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold px-6 py-3 text-xl sm:text-2xl md:text-3xl tracking-wide shadow-2xl hover:shadow-blue-500/50 transition-all duration-300 transform hover:scale-105 font-deardorf">
