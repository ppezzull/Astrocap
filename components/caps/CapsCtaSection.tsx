  ...
  return (
    <section className="py-12 md:py-20 bg-gradient-to-r from-blue-600 to-blue-600">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-5xl font-black text-white mb-4 md:mb-6 font-jakarta">{heading ?? "REALIZZA LA TUA IDEA"}</h2>
  <p className="text-xl md:text-3xl text-white mb-6 md:mb-8 font-semibold font-jakarta">{subtitle ?? "Ogni cappello può diventare un'opera d'arte personalizzata"}</p>
        <Link href="/contact">
