  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4 text-center max-w-4xl">
        ...
        <p className="text-3xl text-gray-300 leading-relaxed font-deardorf">{paragraph ?? "Ogni cappello personalizzato nasce da un processo creativo unico che combina la tua visione con la mia esperienza artigianale. Dalla prima idea al prodotto finito, ogni fase è curata nei minimi dettagli per garantire un risultato eccezionale."}</p>
      </div>
    </section>
  )
}
