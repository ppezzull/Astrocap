    ...
    >
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex justify-start pt-20 md:pt-40 md:gap-10 mb-10 md:mb-28"
          >
            {/* Left: Timeline marker and title (desktop) */}
            ...
            {/* Right: Content vertically centered with title (desktop) */}
            <div className="relative pl-20 pr-8 md:pl-6 w-full h-full flex flex-col md:justify-center">
              <div className="flex flex-col justify-center h-full md:min-h-[320px] md:py-10 md:my-auto">
                {/* Mobile title above content */}
                <h3 className="md:hidden block text-2xl mb-4 text-left font-bold text-white font-jakarta">
                  {item.title}
                </h3>
                <div className="text-lg md:text-2xl text-gray-200 py-3 md:py-6">
                  {item.content}
                </div>
              </div>
            </div>
